...
@implementation UIImage (YTRoundedCorner)
...
- (UIImage *)yt_roundedCornerImage:(NSInteger)cornerSize borderSize:(NSInteger)borderSize {
  ...
  UIImage *image = [self yt_imageWithAlpha];
  ...
  [self yt_addRoundedRectToPath:CGRectMake(borderSize, borderSize, image.size.width - borderSize * 2, image.size.height - borderSize * 2)
                        context:context
